    ...
    match fd {
        Ok(fd) => {
            ...
            match connect(fd, &localhost) {
                Ok(()) => {
                    let _ = query(fd, "helloagainfriendofafriendiknewyouwhen1");
                    let _ = query(fd, "helloagainfriendofafriendiknewyouwhen2");
                    let _ = query(fd, "helloagainfriendofafriendiknewyouwhen3");
                },
                Err(e) => {
